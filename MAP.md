...
26 packages, 49,963 lines of wac, 995 tests,
...
| [`ssz`](packages/ssz/) | **Everything an Altair light client needs is done and checked against Ethereum's vectors. | 709 | 12 | `crypto` |
