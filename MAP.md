...
26 packages, 50,353 lines of wac, 1010 tests,
...
| [`ssz`](packages/ssz/) | **Everything an Altair light client needs is done and checked against Ethereum's vectors. | 764 | 24 | `crypto` |
